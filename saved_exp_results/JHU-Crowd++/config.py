...
__C.DATASET = 'JHU'  # SHHA, SHHB, UCF_CC_50, UCF_QNRF, JHU-Crowd++


__C.NET = 'MSSFNet' #  optional ['MSSFNet', 'VGG16_FPN']

__C.PRE_MSFFNet_WEIGHTS = '../PretrainedModels/MSFFNet_imagenet_pretrained.pth'

__C.RESUME = False  # contine training
__C.RESUME_PATH = './exp/12-28_16-21_QNRF_MSFFNet/latest_state.pth'
