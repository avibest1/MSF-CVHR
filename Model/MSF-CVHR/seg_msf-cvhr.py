...
class HighResolutionNet(nn.Module):
    ...
    def init_weights(self, pretrained='',):
        ...
        if os.path.isfile(pretrained):
            ...
            print("load pre_trained parameters for MSFFNET")

def get_seg_model(**kwargs):
    from model.MSFFNET.default import _C as hr_config
    from model.MSFFNET.default import update_config
    
    update_config(hr_config, './model/MSFFNET/seg_msffnet.yaml')
